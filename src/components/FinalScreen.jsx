...
export default function FinalScreen() {
  ...
  const proposalMessage = `From the moment when I saw you for the first time, everything is changed.
I didn’t even know whether I was missing.
You are not just my friend, but also You make me smile, you make my heart race, and you make me want to be a better version of myself.`
